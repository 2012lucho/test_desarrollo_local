...
module.exports = (socket, io) => {
  ...
  socket.on('agentes_nodo_flujo_coneccion:create', async (payload, callback) => {
    ...
    const name_entrada_nodo = payload?.name_entrada_nodo ? String(payload.name_entrada_nodo).trim() : null;
    ...
    try {
      const [id] = await db('agentes_nodo_flujo_coneccion').insert({ id_nodo_origen, id_nodo_destino, id_flujo, name_salida_nodo, name_entrada_nodo });
