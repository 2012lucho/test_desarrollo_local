<template>
  <div class="p-3">
    <h2 class="h5 mb-3">Barra Lateral</h2>
    <nav class="nav flex-column">
      ...
      <router-link class="nav-link" to="/tecnologias" active-class="active">Tecnologías</router-link>
...
<script setup>
// Componente en Composition API (script setup)
</script>
